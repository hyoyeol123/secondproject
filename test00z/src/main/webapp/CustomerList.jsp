...
background-image: linear-gradient(to right top, #051937, #444964, #808195, #bfbec8, #ffffff);
top: 60px; width: 100%; height: 100%; background-color: lightgray; color: black; line-height: 20px; font-size: 10px; padding-left: 20px">
...
<tr>
	...
	<td><a href = "CustomerModify.jsp?mod_Customer_ID=<%= rs.getString("Customer_ID") %>"><%= rs.getString("Customer_ID") %></a> </td>
