...
<body>
	...
	background-image: linear-gradient(to right, #c0cdbd, #6eb3a4, #0094ae, #006ebe, #2138a8);
	padding-left: 20px">
...
//			joindateStr = transFormat.format(joindate); 
	...
	<tr>
		<td COLSPAN="2">
		<input type = "SUBMIT" value="수정" onclick="return TpModify()"> &nbsp;
		<input type = "button" value="조회" onclick="return searchCheck03()">
		</td>
	</tr>
