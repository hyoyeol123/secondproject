...
background-image: linear-gradient(to right, #75a475, #7bbeb1, #a5d2dd, #dae6f3, #ffffff);
...
%>
	...
	<td><a href = "TpModify.jsp?mod_Tp_ID=<%= rs.getString("Tp_ID") %>"><%= rs.getString("Tp_ID") %></a> </td>
